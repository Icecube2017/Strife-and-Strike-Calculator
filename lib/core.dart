...
Map<String, CharacterType> characterToPanel = {
  ...
  CharacterId.zhuYecheng.id: CharacterType(panelType: PanelType.balanced, regenType: RegenType.halfDragon),
...
Map<String, SkillType> skillToType = {  
  ...
  SkillId.trading.id: SkillType(cooldown: 3, isExclusive: false),
  SkillId.mizar.id: SkillType(cooldown: 3, isExclusive: false),
  SkillId.lunar.id: SkillType(cooldown: 3, isExclusive: false),
  ...
  SkillId.corrosion.id: SkillType(cooldown: 6, isExclusive: false),
  ...
  SkillId.lastStand.id: SkillType(cooldown: 3, isExclusive: false),
...
Map<String, List<String>> cardTags = {
  ...
  CardId.auroraConcussion.id: [TagId.weird.id, TagId.disorder.id],
